...
class ExampleModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.layer1 = torch.nn.Sequential(
            ...
            #torch.nn.Conv2d(image_channels, num_filters, kernel_size=7, stride=1, padding=3),
            torch.nn.Conv2d(image_channels, num_filters, kernel_size=3, stride=1, padding=1),
            torch.nn.RReLU(),
            #torch.nn.LPPool2d(norm_type=2, kernel_size=2, stride=2))
        ...
        self.layer2 = torch.nn.Sequential(
            ...
            #torch.nn.Conv2d(num_filters, 64, kernel_size=7, stride=1, padding=3),
            torch.nn.Conv2d(num_filters, num_filters*2, kernel_size=3, stride=1, padding=1),
            torch.nn.RReLU(),
            #torch.nn.LPPool2d(norm_type=2, kernel_size=2, stride=2))
            torch.nn.MaxPool2d(kernel_size=2, stride=2, padding=0))
        ...
        self.layer3 = torch.nn.Sequential(
            ...
            torch.nn.Conv2d(num_filters*2, num_filters*4, kernel_size=3, stride=1, padding=1),
            torch.nn.RReLU(),
            #torch.nn.LPPool2d(norm_type=2, kernel_size=2, stride=2))
            torch.nn.MaxPool2d(kernel_size=2, stride=2, padding=0))
    ...
    def forward(self, x):
        ...
        assert out.shape == (batch_size, self.num_classes),            f"Expected output of forward pass to be: {expected_shape}, but got: {out.shape}"
        return out
...
if __name__ == "__main__":
    epochs = 10
    batch_size = 64
    #learning_rate = 5e-2 #best for sgd
    learning_rate = 5e-4 #best for adam
    early_stop_count = 4
